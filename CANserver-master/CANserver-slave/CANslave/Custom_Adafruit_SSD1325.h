 ...
 * OLED displays.
 */
class Custom_Adafruit_SSD1325 : public Custom_Adafruit_GFX {
public:

  Custom_Adafruit_SSD1325()
      : Custom_Adafruit_GFX(128, 64) {}
  /*!
   ...
   */
  Custom_Adafruit_SSD1325(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS)
      : Custom_Adafruit_GFX(128, 64), sid(SID), sclk(SCLK), dc(DC), rst(RST), cs(CS) {}
   ...
   * @param RST Reset pin
   */
  Custom_Adafruit_SSD1325(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST)
      : Custom_Adafruit_GFX(128, 64), sid(SID), sclk(SCLK), dc(DC), rst(RST), cs(-1) {}
  /*!
   * @brief Constructor for SSD1325 display
   * @param DC Data/command pin
   * @param RST Reset pin
   * @param CS Chip-select pin
   */
  Custom_Adafruit_SSD1325(int8_t DC, int8_t RST, int8_t CS)
      : Custom_Adafruit_GFX(128, 64), sid(-1), sclk(-1), dc(DC), rst(RST), cs(CS) {}
