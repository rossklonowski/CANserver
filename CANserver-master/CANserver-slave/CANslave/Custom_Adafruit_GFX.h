...
class Custom_Adafruit_GFX : public Print {

public:
  Custom_Adafruit_GFX(int16_t w, int16_t h); // Constructor
...
//   void initButton(Custom_Adafruit_GFX *gfx, int16_t x, int16_t y, uint16_t w,
...
//   void initButtonUL(Custom_Adafruit_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
//                     uint16_t h, uint16_t outline, uint16_t fill,
//                     uint16_t textcolor, char *label, uint8_t textsize);
//   void initButtonUL(Custom_Adafruit_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
//                     uint16_t h, uint16_t outline, uint16_t fill,
...
// class GFXcanvas1 : public Custom_Adafruit_GFX {
// public:
...
// class GFXcanvas8 : public Custom_Adafruit_GFX {
// public:
...
// class GFXcanvas16 : public Custom_Adafruit_GFX {
// public:
